...
iScroll.prototype = {
	...
	_scrollbar: function (dir) {
		...
		if (!that[dir + 'ScrollbarWrapper']) {
			...
			else bar.style.cssText = 'position:absolute;z-index:100;' + (dir == 'h' ? 'height:7px;bottom:1px;left:2px;right:' + (that.vScrollbar ? '7' : '2') + 'px' : 'width:5px;bottom:' + (that.hScrollbar ? '7' : '2') + 'px;top:2px;right:5px;background: #ededed;');
